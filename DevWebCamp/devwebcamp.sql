...
CREATE TABLE `eventos` (
  ...
  CONSTRAINT `eventos_ibfk_1` FOREIGN KEY (`ponente_id`) REFERENCES `ponentes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `eventos_ibfk_2` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `eventos_ibfk_3` FOREIGN KEY (`dia_id`) REFERENCES `dias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `eventos_ibfk_4` FOREIGN KEY (`hora_id`) REFERENCES `horas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `eventos_registros` (
  ...
  CONSTRAINT `eventos_registros_ibfk_4` FOREIGN KEY (`registro_id`) REFERENCES `registros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `eventos_registros_ibfk_5` FOREIGN KEY (`evento_id`) REFERENCES `eventos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `eventos_registros` VALUES (1,6,1),(2,14,1),(3,20,1),(4,5,1),(5,10,1),(6,3,2),(7,6,2),(8,7,2),(9,25,2),(10,13,2);
...
INSERT INTO `regalos` VALUES (1,'Paquete Stickers'),(2,'Camisa Mujer - Chica'),(3,'Camisa Mujer - Mediana'),(4,'Camisa Mujer - Grande'),(5,'Camisa Mujer - XL'),(6,'Camisa Hombre - Chica'),(7,'Camisa Hombre - Mediana'),(8,'Camisa Hombre - Grande'),(9,'Camisa Hombre - XL'),(10,'Ninguno');
...
INSERT INTO `registros` VALUES (1,2,'2F875336RG910251L','7cb21e22',29,7),(2,1,'76S815021T768383M','88089748',12,8),(3,3,'','ea6d343f',27,10);
...
INSERT INTO `usuarios` VALUES (12,' Carlos','May','correo@correo.com','$2y$10$kqo.okyiKX5TLiiBqxr7vupJky3nfsxkS0SJnfdQ45NgYNwryNONS',1,'',0),(13,' Admin','Web','admin@correo.com','$2y$10$.vNLO1fk2yfC/87aPmm/X.a4sk61pIkSwHO4BqKhSd8UsRAlTU9KO',1,'',1),(27,' Prueba','Paypal','paypal@correo.com','$2y$10$HUBtmSIKLrS6I6nkKG9PK.rOBopyK7bdDu4j7yK4XMUom2.YhSPGy',1,'',0),(29,' Virtual','Boleto','virtual@correo.com','$2y$10$C6.I9f8AEKHgsFH3nlV3xuclskCgmp6M7TbnXjBvagoEakHuSqQTK',1,'',0);
...
-- Dump completed on 2023-07-08 18:47:11
